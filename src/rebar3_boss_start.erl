...
init(State) ->
    Provider = providers:create([
        ...
        {example, "rebar3 CB start"}, % How to use the plugin
        {opts, []},                   % list of options understood by the plugin
        {short_desc, "Start ChicagoBoss project in production mode."},
        {desc, "Start ChicagoBoss project in production mode."}
    ]),
